...
gulp.task('build', gulp.series(
	...
	'babel',
	'js',
	gulp.parallel('eslint', 'stylint', 'image', 'spriteSVG', 'copyFonts', 'copyEnv', 'copyLogs', 'copyOther', 'copyBackJS', 'copyBackPug', 'copyBackViews'),
...
gulp.task('watch', function() {
	...
	gulp.watch(`${ADDRESS.source.front.img}**/*.{png,jpg,jpeg,svg}`, gulp.series('image', 'spriteSVG'));
